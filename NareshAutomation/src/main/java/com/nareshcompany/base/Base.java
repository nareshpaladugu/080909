...
import com.nareshcompany.utilities.GetDateTime;
import com.nareshcompany.utilities.HTMLReports;
import com.nareshcompany.utilities.Listener;
...
public class Base {
	...
	public RedBusHomePage redBusHomePage;
	public FacebookHomePage facebookHomePage;
	public SearsHomePage searsHomePage;
	public GenericWebPage genericHtmlTestPage;
	...
	com.nareshcompany.utilities.HTMLReports reports;
	...
	public void testScriptSetup(Method itc) throws Exception {
		...
		case "IE":
			...
			if(configurations.EXECUTION_MODE.isEmpty() || configurations.EXECUTION_MODE.equalsIgnoreCase("local"))
			{
			...
			{
				try {
					oDriver = new RemoteWebDriver(new URL(configurations.getHubUrl()),capabilities);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
